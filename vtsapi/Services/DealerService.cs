...
namespace vahangpsapi.Services
{
    public class DealerService : IDealerService
    {
        ...
        public DealerService(JwtContext jwtContext)
        {
        ...
        public async Task<APIResponse> AddDealer(ManufacturerAddDTO employee)
        {
        ...
        public async Task<APIResponse> UpdateDealer(ManufacturerEditDTO employee)
        {
        ...
        public async Task<APIResponse> GetDealerList(UserReq req)
        {
                ...
                if (emp_key.RoleId == 6)// for manufreacture
                {
                    ...
                    result = await (from e in _jwtContext.EmployeeMaster
                                    ...
                                    from r in roleJoin.DefaultIfEmpty() // Left join
                                                                        // join p in _jwtContext.EmployeeMaster on e.ParentId equals p.EmpId into parentJoin
                                                                        //  from p in parentJoin.DefaultIfEmpty() // Left join
                                    where e.RoleId == 3 // for distributer id
