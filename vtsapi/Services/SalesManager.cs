...
namespace vahangpsapi.Services
{
    public class SalesManagerService : ISalesManagerService
    {
        ...
        public SalesManagerService(JwtContext jwtContext)
        {
        ...
        public async Task<APIResponse> AddSalesManager(ManufacturerAddDTO employee)
        {
            ...
            if (empcheck == 0)
            {
                ...
                if (parent_details.RoleId == 6)
                {
                    emp.fk_delaer_id = 0;
                    emp.fk_distributor_Id = 0;
                    emp.fk_manufacturer_id = parent_details.EmpId;
                }

                if (parent_details.RoleId == 2)
                {
                    emp.fk_delaer_id = 0;
                    emp.fk_distributor_Id = parent_details.EmpId;
                    emp.fk_manufacturer_id = parent_details.fk_manufacturer_id;
                }

                if (parent_details.RoleId == 3)
                {
                    emp.fk_delaer_id = parent_details.EmpId;
                    emp.fk_distributor_Id = parent_details.fk_distributor_Id;
                    emp.fk_manufacturer_id = parent_details.fk_manufacturer_id;
                }
        ...
        public async Task<APIResponse> UpdateSalesManager(ManufacturerEditDTO employee)
        {
        ...
        public async Task<APIResponse> GetSalesManagerList(UserReq req)
        {
            ...
            if (emp_key != null)
            {
                ...
                if (emp_key.RoleId == 6)// for manufreacture
                {
                    ...
                    result = await (from e in _jwtContext.EmployeeMaster
                                    ...
                                    from r in roleJoin.DefaultIfEmpty() // Left join
                                                                        // join p in _jwtContext.EmployeeMaster on e.ParentId equals p.EmpId into parentJoin
                                                                        //  from p in parentJoin.DefaultIfEmpty() // Left join
                                    where e.RoleId == 5 // for distributer id
                                    && (e.fk_admin_id == emp_key.fk_admin_id)

                                    && (e.fk_manufacturer_id == req.ParentId)
                                    && (e.fk_distributor_Id == 0)
                                    && (e.fk_delaer_id ==0)
                ...
                if (emp_key.RoleId == 2)// for distributer
                {
                    ...
                    result = await (from e in _jwtContext.EmployeeMaster
                                    ...
                                    where e.RoleId == 5 // for distributer id
                                    && (e.fk_admin_id == emp_key.fk_admin_id)
                                    && (e.fk_manufacturer_id == emp_key.fk_manufacturer_id)
                                     && (e.fk_distributor_Id == req.ParentId)                                     
                                    && (e.fk_delaer_id == 0)
                ...
                if (emp_key.RoleId == 3)// for dealer
                {
                    ...
                    result = await (from e in _jwtContext.EmployeeMaster
                                    ...
                                    && (e.fk_admin_id == emp_key.fk_admin_id)
                                    && (e.fk_manufacturer_id == emp_key.fk_manufacturer_id)
                                     && (e.fk_distributor_Id == emp_key.fk_distributor_Id)
                                      && (e.fk_delaer_id == req.ParentId)
